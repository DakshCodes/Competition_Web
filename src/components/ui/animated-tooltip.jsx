    ...
    {items.map((item, idx) => (
      <div
        ...
        <img
          ...
          src={item.image}
          alt={item.name}
          className="object-cover !m-0 !p-0 object-center rounded-full h-24 w-24 border-2 group-hover:scale-105 group-hover:z-30 border-white  relative transition duration-500" />
      </div>
    ))}
  </>);
};
